...
int delayLength = 10;                                    // Delay length (in milliseconds) between each main loop iteration
...
String Unit = "D1";                                     // *** MUST CHANGE THIS TO YOUR ASSIGNED UNIT (A1, A2, ..., A5; B1, B2, ..., B5; C1, C2, ..., C5; D1, D2, ..., D5)
String I2CSensorBeingUsed = "SI1145";                   // *** MUST CHANGE THIS TO YOUR ASSIGNED I2C SENSOR ("VEML6070", "VEML7700", "AS7262", "SI1145")
