...
void updateAnalogSensor() {
  InitialData = analogRead(ANALOGSENSOR);   
  AnalogSensorData = (InitialData*33)/16384;
  
  // May need proper formula to get useful values -- otherwise will just see varying analog values
}
