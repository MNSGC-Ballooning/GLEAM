...
void parseData() {
  ...
  if(xbeeData.charAt(0) == 'A' && xbeeData.charAt(1) == '1' && UnitA1Bool == false) {
   ...
   recentUnit = "Data\nreceived\nfrom:\n\nUnit A4";
    ...
    if(UnitC1HeaderReceived == false && ((!isdigit(xbeeData.charAt(15)) && xbeeData.charAt(15)!= ',') || !isdigit(xbeeData.charAt(16)) && xbeeData.charAt(16)!= ',' )){
      UnitC1HeaderReceived = true;
      Serial.print("Header for C1 received");
    }
    ...
    if(UnitC2HeaderReceived == false && ((!isdigit(xbeeData.charAt(15)) && xbeeData.charAt(15)!= ',') || !isdigit(xbeeData.charAt(16)) && xbeeData.charAt(16)!= ',' )){
      UnitC2HeaderReceived = true;
      Serial.println("Header for C2 received");
    }
    ...
    recentUnit = "Data\nreceived\nfrom:\n\nUnit C2";
      ...
      if(UnitC3HeaderReceived == false && ((!isdigit(xbeeData.charAt(15)) && xbeeData.charAt(15)!= ',') || !isdigit(xbeeData.charAt(16)) && xbeeData.charAt(16)!= ',' )){
        UnitC3HeaderReceived = true;
        Serial.println("Header for C3 received");
    }
    ...
    if(UnitC4HeaderReceived == false && ((!isdigit(xbeeData.charAt(15)) && xbeeData.charAt(15)!= ',') || !isdigit(xbeeData.charAt(16)) && xbeeData.charAt(16)!= ',' )){
      UnitC4HeaderReceived = true;
      Serial.println("Header for C4 received");
    }
    ...
    if(UnitC5HeaderReceived == false && ((!isdigit(xbeeData.charAt(15)) && xbeeData.charAt(15)!= ',') || !isdigit(xbeeData.charAt(16)) && xbeeData.charAt(16)!= ',' )){
      UnitC5HeaderReceived = true;
      Serial.println("Header for C5 received");
    }
