...
String Unit = "A3";                                     // *** MUST CHANGE THIS TO YOUR ASSIGNED UNIT (A1, A2, ..., A5; B1, B2, ..., B5; C1, C2, ..., C5; D1, D2, ..., D5)
...
void getHeader(String I2CSensor, String AnalogSensor) {
  ...
  header = "Unit, Time, MagX, MagY, MagZ, Incline, TempC, Photo, " + AnalogSensor + spacer;
  xBeeHeader = String(Unit) + spacer +  "Time, MagX, MagY, MagZ, Incline, TempC, Photo, " + AnalogSensor + spacer;
  ...
  if(I2CSensor == "VEML6070") {
    ...
    header = header + String("Lux");
    xBeeHeader = xBeeHeader + String("Lux") + delimiter;
  }
    ...
    header = header + String("UV");
    xBeeHeader = xBeeHeader + String("UV") + delimiter;
  }
...
void updateDataStrings(String I2CSensor) {
  ...
  Data = Data + String(incline) + spacer;
  Data = Data + String(currentTempC) + spacer;
  ...
  if(I2CSensor == "VEML6070") {
    ...
    Data = Data + String(VEML7700Lux);
    xBeeData = xBeeData + String(VEML7700Lux);
  }
  else if(I2CSensor == "AS7262") {
    ...
    Data = Data + String(SI1145UV);
    xBeeData = xBeeData + String(SI1145UV) + delimiter;
  }
  else {
