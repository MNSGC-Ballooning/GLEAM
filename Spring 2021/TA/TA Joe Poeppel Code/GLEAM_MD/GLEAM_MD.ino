 ...
 * the data to an SD card, and send data to the Central Unit Reciever (CUR) once a request is   |
 * detected from the Central Unit Transmitter (CUT). Designed for a Teensy 3.5 and Teensyduino. |
 ----------------------------------------------------------------------------------------------*/
...
String Unit = "A5";                                     // *** MUST CHANGE THIS TO YOUR ASSIGNED UNIT (A1, A2, ..., A5; B1, B2, ..., B5; C1, C2, ..., C5; D1, D2, ..., D5)
...
void getHeader(String I2CSensor, String AnalogSensor) {
  ...
  // NOTE: XBEE Header can NOT surpass 100 bytes as this is the maximum serial buffer size of the XBee radio  
...
void updateDataStrings(String I2CSensor) {
  ...
  // NOTE: XBEE Data can NOT surpass 100 bytes as this is the maximum serial buffer size of the XBee radio 
